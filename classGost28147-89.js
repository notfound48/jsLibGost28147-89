...
console.log('encr: ' + EncryptedMessage.crypt('Привет Мир!', 'encrypt'));
console.log('authcode: ' + EncryptedMessage.crypt('Авторизация', 'authcode'));
console.log('encr-decr: ' + EncryptedMessage.crypt(EncryptedMessage.crypt('Привет Мир!', 'encrypt'), 'decrypt'));